...
```{r charger,echo=F, fig.align="center",out.width="100%",fig.cap="Battery charger"}
...
```{r lacie,echo=F, fig.align="center",out.width="60%",fig.cap="LaCie drive for file storage"}
